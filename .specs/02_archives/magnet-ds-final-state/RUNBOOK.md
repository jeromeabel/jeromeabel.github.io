...
| [x]  | R3.6      | **shipped** — every gate green on the 20:32 export; both P3-T11 defects fixed and confirmed on live renders. `blog/PostNav` mobile wrap deliberately deferred to R3.7 (in bounds, needs the responsive-convention decision)                                                                                                                                                                                                                                                                                                                           |
| [x]  | R3.7      | **done** — `.specs/00_backlog/magnet-ds-code-convergence.md` seeded: design.md §7 renames/CVA/collapses, every phase-2/3 `CODE DEBT` row, 3 route rebuilds (WorkCard first — no code counterpart), the PostNav mobile wrap, tooling holes, and a "Not debt" list. Cross-refs `figma-raw-value-triage` / `figma-mobile-section-variants` / `figma-mobile-touch-targets` instead of duplicating them. Size L.                                                                                                                                           |
