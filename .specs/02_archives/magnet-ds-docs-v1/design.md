...
- Decision cards stay **distributed** inside the chapter they govern
  ...
  The thesis's "intent before implementation" is honored _within_ the page:
...
> **Correction (post-Task 8, 2026-08-11):** "only truly empty pages (8, 9, 11) are deleted" above rested on a false premise — Task 8's live check
