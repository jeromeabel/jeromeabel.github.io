...
| [ ]  | P2-T11  | **GATE** — run 1 blocked on a brief bug (archive-skipped `_Docs`, false 54/61); brief patched + the 4 owed repairs written in as Steps 3c/3d/3e + Step 6 — **re-run**                                                                                                                    |
