...
| [ ]  | P2-T11  | **GATE** — roster, axes, Gate D, iconOnly 24→32, fake `chevron-down`, raw paints from P2-T02..T07 (see R2.4 verify-raw), rect-hairline masters rebuilt per P2-T10b, `ui/Link/external` `iconSide` axis, `/about` light+dark screenshots, flip the 36 legacy hairlines to `strokesIncludedInLayout` |
