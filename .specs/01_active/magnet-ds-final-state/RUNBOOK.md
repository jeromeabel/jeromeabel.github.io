...
| [x]  | R3.4   | `figma-ds-file.md` rewritten to final state — 101→218 lines; roster 46, 9 pages, 32-frame grid, 407 collections; new **⚠️ Open defects** section above the token tables                                                                                                                                                                     |
