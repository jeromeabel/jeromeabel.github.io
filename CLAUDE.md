...
The shareable documentation entry point in Figma is the `📚 Design system` page
in `Blog Design System v1.0` (file key `ihWIWmvtQPTWgUxlrVjC2c`). The token model is
