...
In a world that feels increasingly chaotic, foundations become the anchor. The how is getting cheaper; the why — architecture, system boundaries, user intent — is becoming the real asset. For Michelle Brush, Systems thinking, reliability engineering, and comfort with complexity are no longer optional.
...
[^3]: [Humans in the Loop: Engineering Leadership in a Chaotic Industry](https://www.infoq.com/presentations/ai-ml-jobs/), Michelle Brush.
