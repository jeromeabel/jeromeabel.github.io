...
import TxtContainer from '../../components/TxtContainer.astro'
...
dsddddddddddddddddddddddddddddddd

<Image src="/images/argentbank-swagger.png" class="mx-auto" width={500} height={500} aspectRatio="16:9" format="avif" alt="Argent Bank Swagger" />
